...
/**
  * Macro under testing
  */
%include "Y:\Users\camendol\SAS_ETL_dev\user_lib\read_delm_files.sas";

libname testlib "Y:\Users\camendol\SAS_ETL_dev\testing\unit\testdata";
/* Read_delm call */
%read_delm_files( src_dir=Y:\Users\camendol\SAS_ETL_dev\data\incoming\
	               ,files=professionaldetail.txt professionaldetail_02.txt
...
%reports(locate=Y:\Users\camendol\SAS_ETL_dev\testing\unit\reports\
         ,test_scenario=read_delm_files Testing
         ,report_label=read_delm_files.html);
