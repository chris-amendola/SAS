...
/**  
  ...
  *  
  */
%macro generate_attrib_ded(attrib_dataset=work.map_spec);
...
/*Local methods*/
  ...
  %macro exception(_desc);
    ...
    %put ****************************************;
   	%put ;
    %put generate_attrib_ded: Usage exception: &_desc;
    %put generate_attrib_ded: Job terminating.;
    %put ;
    %put ****************************************;
